...
**ADB Lite Desktop** — компаньон для плагина **ADB Lite**, который устанавливается в клиенты Telegram **exteraGram** или **AyuGram** на Android.
...
*   **Открытый код** — единственный сетевой запрос — проверка обновлений, ничего никуда не передается
...
> ⚠️ На Windows для запуска, кликните на файл. На Linux запустите файл через терминал, просто написав его путь.
...
2. Скачайте с [релизов](https://github.com/mr-Vestr/adb-lite-desktop/releases) или [соберите сами](#сборка-из-исходников) приложение `ADB Lite Desktop` под вашу ОС;

3. Далее следуйте по инструкциям в приложении для сопрядения устройств.

> ⚠️ Телефон и компьютер должны находиться в одной Wi-Fi сети.
> ⚠️ Если у вас возникнут проблемы с подкобчением, обращайтесь [@mr_vestr](https://t.me/mr_Vestr).
...
*   Буду благодарен, если поставите звезду репозиторию.
...
<p align="center">
  Сделано с ❤️ для сообщества exteraGram & AyuGram
</p>